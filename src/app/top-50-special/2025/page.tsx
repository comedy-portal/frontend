...
export const metadata: Metadata = {
    title: 'Топ-50 сольных стендап концертов 2025 года на русском языке - Comedy Portal',
    ...
    keywords: ['стендап на русском 2025', 'топ стендап концертов', 'лучшие стендап концерты 2025', 'лучшие стендап концерты на русском 2025', 'стендап рейтинг 2025', '50 лучших русских стендап концертов 2025 года'],
}
