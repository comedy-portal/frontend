...
export const metadata: Metadata = {
    title: 'Топ-50 сольных стендап концертов на русском языке - Comedy Portal',
    ...
    keywords: ['топ стендап концертов', 'лучшие стендап концерты', 'русский стендап концерты', 'стендап рейтинг', '50 лучших стендап концертов']
}
