        ...
        <div className="relative z-40">
            ...
            <input
                ...
                className={classNames(
                    'h-8.5 w-full rounded-lg bg-gray-700 px-9 text-sm text-gray-300 placeholder:text-gray-300 focus:bg-white focus:text-gray-950 focus:outline-none focus:placeholder:text-gray-950',
                    {
