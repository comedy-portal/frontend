                ...
                <div className="flex items-start space-x-4">
                    ...
                    <div className="space-y-6">
                        <section className="space-y-2">
                            <h4 className="font-bold">Для устройств Apple (iPhone/iPad) с браузером Safari:</h4>
                            <ol className="list-decimal space-y-2 pl-6">
                                <li>Откройте наш сайт в браузере Safari.</li>
                                <li>
                                    Нажмите на кнопку «Поделиться» (квадрат со стрелкой вверх) в нижней части экрана.
                                </li>
                        ...
                        <section className="space-y-2">
                            ...
                            <ol className="list-decimal space-y-2 pl-6">
                                ...
                                <li>
                                    В выпадающем меню выберите «Установить приложение» (или «Добавить на главный
                                    экран»).
                                </li>
                                <li>
