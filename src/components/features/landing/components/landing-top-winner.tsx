...
const data = [
    ...
    {
        place: 3,
        contentName: 'Крот-Банкрот',
        contentDescription:
            'В этом концерте Игорь иронизирует над собственными страхами и комплексами, делится забавными историями из взрослой жизни — от попыток избежать мошенников до неловких ситуаций с попрошайками. Тарлецкий размышляет о культурной старости, когда общие шутки и отсылки к сериалам перестают работать. Концерт «Крот-банкрот» — это остроумная и глубокая самоирония, приправленная тонкими наблюдениями за человеческой природой, стереотипами и социальными явлениями. Игорь Тарлецкий не просто смешит, но и заставляет задуматься о парадоксах современного мира.',
        contentImage: 'https://img.youtube.com/vi/UD_DbbzExbc/maxresdefault.jpg',
        contentUrl: '/content/special/226',
        authorName: 'Игорь Тарлецкий',
        authorUrl: '/comedians/igor-tarletskiy',
    },
]
