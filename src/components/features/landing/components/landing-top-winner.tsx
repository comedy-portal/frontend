...
const data = [
    ...
    {
        place: 3,
        contentName: 'Концерт в Дилижане',
        contentDescription:
            'Концерт, снятый в октябре 2024 года, демонстрирует характерный для комика абсурдистский и сюрреалистичный юмор. Одной из тем, затронутых в концерте, по словам самого Артура, является положение женщин («Женщинам нелегко»). Зрителей ожидает непредсказуемый и экспериментальный комедийный стиль, свойственный Чапаряну.',
        contentImage: 'https://img.youtube.com/vi/RAhxIkCx_Eg/maxresdefault.jpg',
        contentUrl: '/content/special/18',
        authorName: 'Артур Чапарян',
        authorUrl: '/comedians/artur-chaparyan',
    },
]
