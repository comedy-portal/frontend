                ...
                onConfirm={async () => {
                    try {
                        ...
                        toast.success(
                            ...
                            'Запрос успешно отправлен. Проверьте вашу электронную почту.',
                        )
                    } catch {
    ...
    return (
        <div className="flex flex-col gap-y-4 border-t border-gray-200 py-8 last:border-b">
            ...
            <div className="text-sm text-gray-500">
                Вы можете запросить копию ваших персональных данных, которые мы храним. Это включает в себя любую
                информацию, которую Вы предоставили нам при регистрации, например, ваше имя пользователя, адрес
                электронной почты и другие дополнительные сведения. Подробнее в нашей{' '}
