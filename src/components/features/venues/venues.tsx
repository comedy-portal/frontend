        ...
        <div>
            <div className="bg-gray-950 text-white">
                <div className="wrapper relative h-130">
                    <div
                        className="absolute inset-0 bg-cover bg-center bg-no-repeat mask-contain mask-no-repeat sm:mask-[linear-gradient(to_right,transparent_0%,black_30%,black_70%,transparent_100%)]"
                        style={{ backgroundImage: `url(${assetsUrlBuilder('venues', 'hero.jpg')})` }}
                    ></div>
