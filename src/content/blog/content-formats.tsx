...
const article: BlogArticle = {
    ...
    content: (
        <>
            ...
            <p>На&nbsp;<strong>Камеди Портал</strong> мы&nbsp;собрали все основные форматы комедийного контента и&nbsp;аккуратно разложили их&nbsp;по&nbsp;категориям. В&nbsp;этой статье вы&nbsp;найдёте краткое и&nbsp;понятное описание каждого из&nbsp;них&nbsp;&mdash; чтобы легко ориентироваться на&nbsp;сайте и&nbsp;быстро выбирать&nbsp;то, что хочется посмотреть именно сейчас.</p>
            ...
            <section className="space-y-4">
                <h2 className="text-lg font-semibold">Командные шоу</h2>
                <p>
                    <strong>Юмористические шоу или концерты</strong>, в&nbsp;которых выступает одна или несколько команд комиков. Формат может быть как несостязательным&nbsp;&mdash; в&nbsp;виде цельного выступления команды, так и&nbsp;соревновательным, где команды борются за&nbsp;награду. Командные шоу могут быть разовыми мероприятиями либо выходить в&nbsp;виде серии выпусков на&nbsp;протяжении длительного времени.
                </p>
            </section>
        </>
    ),
