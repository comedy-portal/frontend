...
const article: BlogArticle = {
    ...
    preview: {
        ...
        description: 'Профиль пользователя на Камеди Портал: статистика просмотров, оценки, избранное и рекомендации. Узнайте, какие возможности доступны после регистрации.',
    },
