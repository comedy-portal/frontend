...
const article: BlogArticle = {
    ...
    metadata: {
        ...
        keywords: [
            ...
            'скачать камеди портал',
            'камеди портал на смартфоне',
            'камеди портал на компьютере',
            'установка камеди портал',
            'как установить камеди портал',
            'смотреть комедию онлайн',
            'комедийные шоу приложение',
            'смотреть стендап приложение',
            'смотреть стендап',
        ],
        openGraph: {
            type: 'article',
            ...
            images: [
                {
                    ...
                    width: 1200,
                    height: 630,
                    alt: 'Установите Камеди Портал на смартфон или компьютер',
                },
            ],
            locale: 'ru_RU',
        },
